...
# RUN: lld-link -machine:arm64x -noentry -dll funcs-arm64ec.obj space-aarch64.obj loadconfig-arm64ec.obj \
# RUN:          loadconfig-arm64.obj -out:testx.dll -verbose 2>&1 | FileCheck -check-prefix=VERBOSE %s
...
# RUN: lld-link -machine:arm64x -noentry -dll funcs-arm64ec.obj funcs-aarch64.obj loadconfig-arm64ec.obj \
# RUN:          loadconfig-arm64.obj -out:testx2.dll -verbose 2>&1 | FileCheck -check-prefix=VERBOSEX %s
