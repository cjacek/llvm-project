...
private:
  ...
  bool findUnderscoreMangle(COFFNamespace &ns, StringRef sym);
  ...
  void parseModuleDefs(COFFNamespace &ns, StringRef path);
  ...
  void maybeExportMinGWSymbols(COFFNamespace &ns,
  ...
  Symbol *addUndefined(COFFNamespace &ns, StringRef sym, bool aliasEC = false);

  void addUndefinedGlob(StringRef arg);

  StringRef mangleMaybe(COFFNamespace &ns, Symbol *s);
  ...
  void fixupExports(COFFNamespace &ns);
  void assignExportOrdinals(COFFNamespace &ns);
