...
std::vector<WrappedSymbol> addWrappedSymbols(COFFNamespace &ns,
                                             llvm::opt::InputArgList &args);

void wrapSymbols(COFFNamespace &ns, ArrayRef<WrappedSymbol> wrapped);
